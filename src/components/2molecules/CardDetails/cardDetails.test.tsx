...
describe('CardDetails not favorite', () => {
  beforeEach(() => {
    render(<CardDetails person={jsonMock} isFavorite={false} />);
  });
  ...
  it('should contain the good SVG (not filled)', () => {
    const path = screen.getByRole('button').querySelector('svg > path:nth-child(2)');
...
describe('CardDetails favorite', () => {
  beforeEach(() => {
    render(<CardDetails person={jsonMock} isFavorite />);
  });
